...
class MyCombinedScaledReward(CombinedReward):
    ...
    def initialize(self, env):
        ...
        # added by Jason
        self.addReward("sbox", MySandboxReward(), 200.0)
        self.addReward("nanyang", MyNewReward(), 1000.0)
        self.addReward("dist", MyDistanceReward(), 200.0)
        #self.addReward("overflow", MyCloseToOverFlowNoFlowReward(), 200.0)


        # self.addReward("sbox", MySandboxReward(), 100.0)
        # self.addReward("overflow", MyCloseToOverFlowReward(), 200.0)
        # self.addReward("dist", MyDistanceReward(), 40.0)
        # self.addReward("conn", MyLinesConnectedReward(), 180.0)

        #self.addReward("cap", MyLinesCapacityReward(), 10.0)
        #self.addReward("redisp", RedispReward(), 1e-5)
        #self.addReward("game", GameplayReward(), 18.0)
