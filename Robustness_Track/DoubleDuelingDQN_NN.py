...
class DoubleDuelingDQN_NN(object):
    ...
    def construct_q_network(self):
        ...
        lay3 = tfkl.Dense(self.action_size, name="fc_3")(lay2)        #896
        lay3 = tfka.relu(lay3, alpha=0.01) #leaky_relu

        lay4 = tfkl.Dense(self.action_size, name="fc_4")(lay3)        #512
        lay4 = tfka.relu(lay4, alpha=0.01) #leaky_relu
        #
        advantage = tfkl.Dense(self.action_size, name="fc_adv")(lay4)  #384
        ...
        value = tfkl.Dense(self.action_size, name="fc_val")(lay4)      #384
