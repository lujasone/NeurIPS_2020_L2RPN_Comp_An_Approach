...
class DoubleDuelingDQN_NN(object):
    ...
    def construct_q_network(self):
        ...
        lay1 = tfka.relu(lay1, alpha=0.01)
        
        lay3 = tfkl.Dense(self.observation_size, name="fc_3")(lay1)        #896
        lay3 = tfka.relu(lay3, alpha=0.01) #leaky_relu

        lay5 = tfkl.Dense(self.action_size, name="fc_5")(lay3)  # 512
        lay5 = tfka.relu(lay5, alpha=0.01)  # leaky_relu

        advantage = tfkl.Dense(self.action_size, name="fc_adv")(lay5)  #384
        ...
        value = tfkl.Dense(self.action_size, name="fc_val")(lay5)      #384
